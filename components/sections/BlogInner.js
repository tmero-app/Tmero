    ...
    return (
        <section className="news-section">
            <div className="auto-container">
                ...
                <div className="row">
                    {data.map((item) => (
                        <div key={item.id} className="news-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
                            <div className="inner-box">
                                <div className="image-box">
                                    <figure className="image">
                                        <Link href={{ pathname: "/news-details", query: { id: item.id } }}>
                                            <img src={`images/resource/${item.img}`} alt={item.title} title="Tmero" />
                                        </Link>
                                    </figure>
                                </div>
                                <div className="content-box">
                                    <div className="content">
                                        ...
                                        <Link href={{ pathname: "/news-details", query: { id: item.id } }} className="read-more">
